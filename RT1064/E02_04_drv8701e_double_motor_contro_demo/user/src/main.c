...
#define MOTOR2_PWM               (PWM2_MODULE0_CHA_C6)                    //右后方电机

#define MOTOR3_DIR               (D2 )
#define MOTOR3_PWM               (PWM2_MODULE3_CHB_D3)                  //前方电机

#define MOTOR4_DIR               (C10 )
#define MOTOR4_PWM               (PWM2_MODULE2_CHB_C11)                 //左后方电机
int8 duty = 10;
bool dir = true;
...
//            pwm_set_duty(MOTOR1_PWM, duty * (PWM_DUTY_MAX / 100));                   // 计算占空比
            ...
            gpio_set_level(MOTOR2_DIR, GPIO_HIGH);                                         // DIR输出高电平(顺时针）
