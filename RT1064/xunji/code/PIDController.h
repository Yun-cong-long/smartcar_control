...
#define PID_DEFAULT_PRECISION	0.001f	//控制精度，当目标速度与实际速度小于此值时，认为没有误差，使PID更稳定
#define PID_DEFAULT_ERRALL_MAX 2000	//控制ERR_ALL最大值，否则ERR_ALL最大值过大，会使PID反应慢，不稳定，积分限幅
#define PID_DEFAULT_OUTPUT_MAX 6000	//输出限幅
...
typedef enum
{
	...
	RampDefault_Time = 0,//计数多少次才把count加上1个步幅
}PID_RampState_e;
...
void PID_SetTargetWithNormal(PID_t* WhichPID,float Target);
