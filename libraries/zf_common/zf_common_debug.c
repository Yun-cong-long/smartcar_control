...
void debug_init (void)
{
    ...
    uart_init(
     ...
     uart_init(
        DEBUG_UART4_INDEX,                                                       // 在 zf_common_debug.h 中查看对应值
        DEBUG_UART4_BAUDRATE,                                                    // 在 zf_common_debug.h 中查看对应值
        DEBUG_UART4_TX_PIN,                                                      // 在 zf_common_debug.h 中查看对应值
        DEBUG_UART4_RX_PIN);                                                     // 在 zf_common_debug.h 中查看对应值
    ...
    uart_rx_interrupt(DEBUG_UART_INDEX, 1);                                     // 使能对应串口接收中断
	  uart_rx_interrupt(DEBUG_UART4_INDEX, 1);                                     // 使能对应串口接收中断
#endif
}
