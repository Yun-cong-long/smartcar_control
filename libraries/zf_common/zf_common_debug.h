...
#define DEBUG_UART4_INDEX            (UART_4)                                    // 指定 debug uart 所使用的的串口
#define DEBUG_UART4_BAUDRATE         (115200)                                    // 指定 debug uart 所使用的的串口波特率
#define DEBUG_UART4_TX_PIN           (UART4_TX_C16 )                             // 指定 debug uart 所使用的的串口引脚
#define DEBUG_UART4_RX_PIN           (UART4_RX_C17)                              // 指定 debug uart 所使用的的串口引脚
